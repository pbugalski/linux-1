...
/**
 * nand_exit_status_op - Send a READ0 cmd to exit STATUS mode
 * @chip: The NAND chip
 *
 * This function sends a READ command to exit GET STATUS mode.
 * This function does not select/unselect the CS line.
 *
 * Returns 0 for success or negative error code otherwise
 */
...
/**
 * nand_write_data_op - Read data from the NAND
 * @chip: The NAND chip
